...
| Web UI | https://192.168.0.50:8006 → prox.myownserv.duckdns.org |
...
| Check interval | 30s |
| Shutdown webhook | http://192.168.0.50:9999/shutdown (also /reboot) |
| WOL target | MAC 00:23:24:c7:1f:5d, broadcast 192.168.0.255 |
| Pi notify URL | http://192.168.0.169:9997/notify?event=... |
| ESP32 state API | GET http://192.168.0.178/state |
| ESP32 command API | POST http://192.168.0.178/command |
| Flap detection | 3 events / 10 min rolling window |
| Extender uptime | http://192.168.0.169:9998/extender-uptime |

### PlatformIO Config (LXC 117 — `/opt/esp32-ups-monitor/platformio.ini`)
